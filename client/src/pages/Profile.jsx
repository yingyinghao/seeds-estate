  ...
  <div className="p-3 max-w-lg mx-auto">
    ...
    <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
      ...
      <p className='text-sm self-center'>
        {fileUploadError ? (
      <span className = 'text-red-700'> Error image upload (imagee less than 2 )</span>
      ...
      />
       ...
       />
        ...
        <Link className="bg-green-700 text-white p-3 rounded-lg uppercase text-center hover:opacity-95" to={"/create-listing"}> Creatre Listing
        </Link>
    </form>
    <div className="flex justify-between mt-5">
      ...
      <span onClick = { handleSignOut } className="text-red-700 cursor-pointer">Sign out</span>
       ...
       <button onClick={handleShowListings} className="txte-green-700 w-full">Show Listings</button>
        ...
        <div className="flex flex-col gap-4">
          <h1 className="text-center mt-7 text-2xl font-semibold">Your Listings</h1>
            {userListings.map((listing) =>(
              ...
              <Link className="text-slate-700 font-semibold flex-1 hover:underline truncate flex-1"
